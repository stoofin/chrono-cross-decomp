...
void SoundVM_A1_LoadInstrument( FSoundChannel* in_pChannel, u32 in_VoiceFlags )
{
    ...
    in_pChannel->UpdateFlags &= ~( 
        ...
        SOUND_CHANNEL_UPDATE_LOCK_ATTACK_MODE | 
...
void SoundVM_B3_ResetAdsr( FSoundChannel* in_pChannel, u32 in_VoiceFlags )
{
    ...
    in_pChannel->UpdateFlags &= ~(SOUND_CHANNEL_UPDATE_LOCK_ATTACK_MODE | SOUND_CHANNEL_UPDATE_LOCK_SUSTAIN_RATE | SOUND_CHANNEL_UPDATE_LOCK_RELEASE_RATE);
}
...
void SoundVM_AD_AttackRate( FSoundChannel* in_pChannel, u32 in_VoiceFlags )
{
    ...
    in_pChannel->UpdateFlags |= SOUND_CHANNEL_UPDATE_LOCK_ATTACK_MODE;
}
