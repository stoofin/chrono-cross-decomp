...
void Sound_Setup()
{
    ...
    g_PrimaryMusicContext.A_Volume = 0x7F0000;
    g_PrimaryMusicContext.B_Volume = 0x400000;
    g_CdVolume = 0x7FFF0000;
    D_800919C0 = 0;
    g_Sound_MasterPitchScaleQ16_16 = 0;
    D_800919C2 = 0;
    g_Sound_TempoMultiplier = 0;
    g_PrimaryMusicContext.A_StepsRemaining = 0;
    g_PrimaryMusicContext.B_StepsRemaining = 0;
