...
#define SOUND_CMD_A0_SET_SFX_VOLUME_MOD                  ( 0xA0U )
#define SOUND_CMD_A1_FADE_SFX_VOLUME_MOD                 ( 0xA1U )
#define SOUND_CMD_A2_SET_SFX_PAN_MOD                     ( 0xA2U )
#define SOUND_CMD_A3_FADE_SFX_PAN_MOD                    ( 0xA3U )
#define SOUND_CMD_A4_SET_SFX_PITCH_MOD                   ( 0xA4U )
#define SOUND_CMD_A5_FADE_SFX_PITCH_MOD                  ( 0xA5U )
#define SOUND_CMD_A8_SET_ALL_SFX_VOLUME_MOD              ( 0xA8U )
#define SOUND_CMD_A9_FADE_ALL_SFX_VOLUME_MOD             ( 0xA9U )
#define SOUND_CMD_AA_SET_ALL_SFX_PAN_MOD                 ( 0xAAU )
#define SOUND_CMD_AB_FADE_ALL_SFX_PAN_MOD                ( 0xABU )
#define SOUND_CMD_AC_SET_ALL_SFX_PITCH_MOD               ( 0xACU )
